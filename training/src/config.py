...
parser.add_argument("--predictor", type=str, choices=["NeuralNetwork", "GraphNeuralNetwork", "Linear", "GraphNeuralNetwork_sparse"], default="GraphNeuralNetwork")
...
parser.add_argument("--feature_set", type=str, choices=["static", "dynamic", "dynamicstatic"], default="dynamic")